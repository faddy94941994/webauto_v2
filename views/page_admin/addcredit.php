...
<div class="bg-secondary rounded p-4 m-10" style= margin:30px;>
		<div class="info-box">
			<h4 class="text-black"><i class="fas fa-plus-square"></i> เพิ่มเครดิต - <?php echo $LoadConfig->user_agent; ?><?php echo $date_member->username_mb; ?> : <?php echo $date_member->name_mb; ?></h4>
			<hr>
			<div class="row mb-3">
				<div class="col-md-3">
