...
<head>
    <meta charset="utf-8">
    <title>Betingsoft backend System</title>
...
<body>
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Betingsoft</h3>
                            </a>
                            <h3>ระบบหลังบ้าน</h3>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="https://www.betingsoft.com">ลืมรหัสผ่าน</a>
                        </div>
                        <button type="submit" button id="submitlogin"  class="btn btn-primary py-3 w-100 mb-4">เข้าสู่ระบบ</button>
                        <p class="text-center mb-0">ติดต่อเรื่องระบบ <a href="https://www.betingsoft.com">คลิ๊ก</a></p>
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="text-center">
						<a class="txt" href="#">
							2022 © betingsoft All Rights Reserved. | Version: (2.6.33)</a>
					</div>
