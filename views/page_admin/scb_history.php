	...
	<span class="logo-mini"><img src="<?php echo $logo; ?>" width="150" alt=""></span> <span class="logo"></a></h3>
		...
		<ul class="sidebar-menu" data-widget="tree">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="/admin/scb_history" class="dropdown-item active"><i class="fas fa-landmark me-2"></i>รายการ SCB</a>
...
<div class="bg-secondary rounded p-4 m-10" style= margin:30px;>
		<div class="info-box">
			<h4 class="text-black"><i class="fas fa-history"></i> ประวัติรายการ SCB</h4>
			<hr>
			<div class="row mb-3">
...
function showdatelist(GetDate) {
	...
	$.each(GetDate.result, function( index, value ) {
		...
		if(value.type =="ฝากเงิน" || value.type =="Deposit"){
			str_type = '<span class="btn btn-info btn-sm px-2 noHover">รับโอนเงิน</span>';
		} else if (value.type =="ถอนเงิน" || value.type =="Withdrawal") {
		...
		html += '<th scope="col">' + value.details + '</th>';
		html += '<th scope="col">' + value.date_check + '</th>';
		html += '<th scope="col">' + value.time_check + '</th>';
		html += '</tr>';
	});
