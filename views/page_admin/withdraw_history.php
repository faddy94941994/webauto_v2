	...
	<span class="logo-mini"><img src="<?php echo $logo; ?>" width="150" alt=""></span> <span class="logo"></a></h3>
		...
		<ul class="sidebar-menu" data-widget="tree">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/admin/withdraw_history" class="dropdown-item  active"><i class="fas fa-history me-2"></i>ประวัติ การถอน </a>
                    </div>
...
<div class="bg-secondary rounded p-4 m-10" style= margin:30px;>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="info-box">
					<h4 class="text-black"><i class="fas fa-history"></i> เช็คข้อมูลการถอน</h4>
					<hr>
					<div class="row mb-3">
						<div class="col-md-8">
...
function showdatelist(GetDate) {
	...
	$.each(GetDate.result, function( index, value ) {
		...
		html += '<th scope="col"><?php echo $LoadConfig->user_agent; ?>' + value.username_wd + '</th>';
		html += '<th scope="col">' + value.amount_wd + '</th>';
		html += '<th scope="col">' + value.amount_cashback + '</th>';
		html += '<th class="text-decoration-none">' + value.bankout_wd + '</th>';
		html += '<th scope="col">' + value.phone_wd + '</th>';
		html += '<th scope="col">' + value.name_wd + '</th>';
		html += '<th scope="col">' + value.add_wd + '</th>';
		html += '<th scope="col">' + value.edit_wd + '</th>';
		html += '<th scope="col" class="text-nowrap">' + value.date_wd + '</th>';
		html += '<th scope="col"><a href="/admin/withdrawupdateform?id=' + value.id + '" class="btn btn-sm btn-info px-2"><i class="fas fa-edit"></i> แก้ไข</a></th>';
		html += '</tr>';
	});
...
$.ajax({
      type: "POST",
      url: "/api/admin/loadwithdrawhistory",
      data: {
          search:search,
