...
<div class="bg-secondary rounded p-4 m-10" style= margin:30px;>
		<div class="info-box">
			<div class="d-flex">
			  <div class="mr-auto"><h4 class="text-black"><i class="fas fa-history"></i> ประวัติเข้าใช้งาน - พนักงาน</h4></div>
			</div>
			<hr>
			<div class="table-responsive">
				<table class="table table-bordered text-nowrap text-center">
					<thead class="text-black">
						<tr>
							<th scope="col" class="align-middle px-2">ชื่อ-พนักงาน</th>
							<th scope="col">เวลา เข้าใช้งาน</th>
							<th scope="col">บนระบบ</th>
					...
					<tbody>
<?php 
$sql_staff = "SELECT * FROM logadmin ORDER BY id DESC limit 20";
$load_date_staff = $class_admin->load_date_sql($sql_staff);
while($row = mysqli_fetch_array($load_date_staff)) {
?>
								<tr>
									<td class="align-middle"><?php echo $row["name"]; ?></td>
									<td class="align-middle"><?php echo $row["datelogin"]; ?></td>
									<td class="align-middle"><?php echo $row["OnSystem"]; ?></td>
									<td class="align-middle"><?php echo $row["Browser"]; ?></td>
									<td class="align-middle"><?php echo $row["Ipaddress"]; ?></td>
								</tr>	
<?php } ?>					
					</tbody>
				</table>
