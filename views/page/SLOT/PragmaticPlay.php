            <div class="-games-index-page">
               <h2 class="-heading-sub-title">เกมส์ PragmaticPlay</h2>
...
<?php
$json_data = file_get_contents('https://betflik.com/games_share/pp.txt', true);
...
?>
                           ...
                           <li class="nav-item -random-container -game-casino-macro-container ">
                              <a href="javascript:void(0)" data-namegame="pp" data-codegame="<?php echo $value['code']; ?>" class="nav-link js-account-approve-aware ClassStartGame">
                                 <picture>
									<img src="<?php echo str_replace("http://","https://",$value['img']); ?>" width='250' height='231' class='-cover-img lazyload img-fluid' alt='SLOT' onerror='ImgError(this)'>
                                 </picture>
                              </a>
