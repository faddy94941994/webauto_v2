         ...
         <div class="x-event-index-container">
                  ...
                  <div class="col-12">
                     <div class="x-page-title-component ">
                        <div class="-inner-wrapper">
                           <h1 class="-title">สิทธิพิเศษ</h1>
                           <img src="assets2/build/web/igame-index-lobby-wm/img/line-glow-blue.png" class="-line-img" alt="Page title line glow">
                           <img src="assets2/build/web/igame-index-lobby-wm/img/index-lobby-ic-header-menu-event.png" class="-img -item-1" alt="Page title icon">
                           <img src="assets2/build/web/igame-index-lobby-wm/img/index-lobby-ic-header-menu-event.png" class="-img -item-2" alt="Page title icon">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               <div class="row -row-wrapper x-divine-gutter">
                  <div class="col-12 col-md-6 -col-wrapper x-divine-gutter">
                     <a href="<?php echo $Get_Setting->lineoa; ?>" class="x-event-item-wrapper" target="_self">
                     <img src="assets2/build/web/igame-index-lobby-wm/img/index-lobby-best-casino-online.png" class="-cover" alt="Event best-casino image png" width="385" height="140">
                     </a>
                  </div>
                  <div class="col-12 col-md-6 -col-wrapper x-divine-gutter">
                     <a href="<?php echo $Get_Setting->lineoa; ?>" class="x-event-item-wrapper" target="_self">
                     <img src="assets2/build/web/igame-index-lobby-wm/img/event-banner-ranking.png" class="-cover" alt="Event ranking image png" width="385" height="140">
                     </a>
                  </div>
                  <div class="col-12 col-md-6 -col-wrapper x-divine-gutter">
                     <a href="<?php echo $Get_Setting->lineoa; ?>" class="js-account-approve-aware x-event-item-wrapper" data-toggle="modal" data-target="#loginModal">
                     <img src="assets2/media/cache/strip/202109/social-promotion/de065347eb0db87f4788c26e10bee312.png" class="-cover" alt="Event social-share image png" width="385" height="140">
                     </a>
                  </div>
               </div>
            </div>
         ...
         <div class="-footer-inner-wrapper">
            <div class="-describe-wrapper">
               <div class="-content-wrapper">
                  <h6 class="-title"><?php echo $Get_Setting->name_web; ?> เว็บคาสิโนออนไลน์ <br> ครองอันดับในใจคนไทย 3 ปีซ้อน</h6>
