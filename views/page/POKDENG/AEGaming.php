            <div class="-games-index-page">
               <h2 class="-heading-sub-title">เกมส์ AE Gaming</h2>
...
<?php
$json_data = file_get_contents('https://betflik.com/games_share/aws.txt', true);
$array = json_decode($json_data, true);
 
foreach ($array as  $value) {
	
	
$array_type = array("TABLE");
...
?>
                           ...
                           <li class="nav-item -random-container -game-casino-macro-container ">
                              <a href="javascript:void(0)" data-namegame="aws" data-codegame="<?php echo $value['code']; ?>" class="nav-link js-account-approve-aware ClassStartGame">
                                 <picture>
