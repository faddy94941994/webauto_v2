            <div class="-games-index-page">
               <h2 class="-heading-sub-title">เกมส์ NETENT</h2>
...
<?php
$json_data = file_get_contents('https://betflik.com/games_share/netent.txt', true);
...
?>
                           ...
                           <li class="nav-item -random-container -game-casino-macro-container ">
                              <a href="javascript:void(0)" data-namegame="netent" data-codegame="<?php echo $value['code']; ?>" class="nav-link js-account-approve-aware ClassStartGame">
                                 <picture>
