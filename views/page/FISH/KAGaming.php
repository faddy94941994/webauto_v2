            <div class="-games-index-page">
               <h2 class="-heading-sub-title">เกมส์ KAGaming</h2>
...
<?php
$json_data = file_get_contents('https://betflik.com/games_share/kg.txt', true);
...
?>
                           ...
                           <li class="nav-item -random-container -game-casino-macro-container ">
                              <a href="javascript:void(0)" data-namegame="kg" data-codegame="<?php echo $value['code']; ?>" class="nav-link js-account-approve-aware ClassStartGame">
                                 <picture>
									<img src="<?php echo $value['img'];?>" width='250' height='231' class='-cover-img lazyload img-fluid' alt='FISH' onerror='ImgError(this)'>
                                 </picture>
                              </a>
