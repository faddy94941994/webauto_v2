<?php	
    class iWallet {
		...
		public $api_gateway = "http://api.truewallet.me/";
		...
		public function GetProfile() {
			...
			return $this->request("iden.php?phone=".$this->phoneNumber."&pin=".$this->Pin."&type=Profile");
		}	

		public function GetBalance() {
			if (is_null($this->Pin) || is_null($this->phoneNumber)) return false; 
			return $this->request("iden.php?phone=".$this->phoneNumber."&pin=".$this->Pin."&type=Balance");
		}					
						
		public function GetTransaction() {
			if (is_null($this->Pin) || is_null($this->phoneNumber)) return false; 
			return $this->request("iden.php?phone=".$this->phoneNumber."&pin=".$this->Pin."&type=Transaction");
		}

		public function Login_nox() {
			if (is_null($this->Pin) || is_null($this->phoneNumber)) return false; 
			return $this->request("iden.php?phone=".$this->phoneNumber."&pin=".$this->Pin."&type=Login");
		}
		
		public function Checkname($phone) {
			if (is_null($this->Pin) || is_null($this->phoneNumber)) return false; 
			return $this->request("iden.php?phone=".$this->phoneNumber."&pin=".$this->Pin."&ref=".$phone."&type=Cp2p");
		}
		
		public function P2p($phone, $amount) {
			if (is_null($this->Pin) || is_null($this->phoneNumber)) return false; 
			return $this->request("iden.php?phone=".$this->phoneNumber."&pin=".$this->Pin."&ref=".$phone."&amount=".$amount."&type=P2p");
		}							
